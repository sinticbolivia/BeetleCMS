...
<div class="wrap">
			...
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
				<div class="page-buttons">
					<a class="btn btn-primary has-popover" href="<?php print $new_link; ?>" 
						data-content="<?php _e('CONTENT_BUTTON_NEW'); ?>">
	...
	<tr>
		<th>#</th>
		<th>
			<a href="<?php print $id_order_link; ?>" class="has-popover" data-content="<?php _e('CONTENT_TH_ID'); ?>">
				<?php _e('ID', 'content'); ?>
		...
		<th>
			<a href="<?php print $title_order_link; ?>" class="has-popover" data-content="<?php _e('CONTENT_TH_TITLE'); ?>" >
				<?php _e('Title', 'content'); ?>
				<span class="glyphicon glyphicon-triangle-<?php print ($this->request->getString('order_by') == 'title' && $this->request->getString('order', 'asc') == 'asc') ? 'bottom' : 'top'; ?>"></span>
			</a>
		</th>
		<th>
			<a href="<?php print $author_order_link; ?>" class="has-popover" data-content="<?php _e('CONTENT_TH_AUTHOR'); ?>">
				<?php _e('Author', 'content'); ?>
				<span class="glyphicon glyphicon-triangle-<?php print ($this->request->getString('order_by') == 'author' && $this->request->getString('order', 'asc') == 'asc') ? 'bottom' : 'top'; ?>"></span>
			</a>
		</th>
		<th><a href="javascript:;"><?php _e('Sections', 'content'); ?></a></th>
		<th>
			<a href="<?php print $order_link; ?>" class="has-popover" data-content="<?php print $this->__('CONTENT_TH_ORDER'); ?>">
		...
		<th>
			<a href="<?php print $date_order_link; ?>" class="has-popover" data-content="<?php print $this->__('CONTENT_TH_DATE'); ?>">
				<?php _e('Date', 'content'); ?>
				<span class="glyphicon glyphicon-triangle-<?php print ($this->request->getString('order_by') == 'creation_date' && $this->request->getString('order', 'asc') == 'asc') ? 'bottom' : 'top'; ?>"></span>
			</a>
		</th>
	</tr>
	</thead>
	...
	<tr>
		...
		<td>
			...
			<div>
				<a href="<?php print $this->Route('index.php?mod=content&view=edit&id='.$c->content_id); ?>" 
					title="<?php print $this->__('Edit', 'content')?>"
					class="btn btn-default btn-xs">
					<span class="glyphicon glyphicon-edit"></span>
				</a>
				<a href="<?php print $this->Route('index.php?mod=content&task=delete&id='.$c->content_id); ?>" 
					class="confirm btn btn-default btn-xs" 
					data-message="<?php print $this->__('Are you sure to delete the content?'); ?>"
					title="<?php print $this->__('Delete', 'content')?>">
