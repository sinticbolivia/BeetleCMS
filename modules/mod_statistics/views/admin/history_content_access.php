...
?>
<div class="wrap">
	<h2><?php print SBText::_('Historial Acceso por Contenidos', 'statistics'); ?></h2>
	...
	<form action="<?php print SB_Route::_('index.php') ?>" method="get">
		...
		<input type="hidden" name="view" value="history_content_access" />
		<input type="hidden" name="page" value="<?php print 1; ?>" />
		<input type="hidden" name="order_by" value="<?php print $order_by; ?>" />
		<div class="form-horizontal">
			<div class="form-group">
				<label class="col-sm-1 control-label has-popover" data-content="<?php print SBText::_('STATS_CONT_H_DATE_FROM'); ?>">
				...
				<div class="col-sm-1">
					<label class="control-label has-popover" data-content="<?php print SBText::_('STATS_CONT_H_DATE_TO'); ?>">
			...
			<div class="form-group">
				<label class="col-sm-1 control-label has-popover" data-content="<?php print SBText::_('STATS_CONT_H_SEARCH_IDS'); ?>">
				...
				<div class="col-sm-1">
					<button type="submit" class="btn btn-default has-popover" data-content="<?php print SBText::_('STATS_CONT_H_BUTTON_FILTER'); ?>">
						<?php print SBText::_('Filtrar'); ?>
					</button>
				</div>
			</div>
		</div>
	...
	<tr>
		<th>#</th>
		<th>
			<a href="<?php print $order_id_link; ?>" class="has-popover" data-content="<?php print SBText::_('STATS_CONT_H_TH_ID'); ?>">
				ID
		...
		<th>
			<a href="<?php print $order_title_link; ?>" class="has-popover" data-content="<?php print SBText::_('STATS_CONT_H_TH_ARTICLE'); ?>">
				<?php print SBText::_('Contenido', 'statistics'); ?>
		...
		<th>
			<a href="<?php print $order_username_link; ?>" class="has-popover" data-content="<?php print SBText::_('STATS_CONT_H_TH_USERNAME'); ?>">
		...
		<th>
			<a href="<?php print $order_creation_date_link; ?>" class="has-popover" data-content="<?php print SBText::_('STATS_CONT_H_TH_ACCESS_DATE'); ?>">
