...
<div class="container">
	<h1>
		...
		<?php print SB_Text::_('Errores de Login', 'statistics'); ?>
	</h1>
	...
	<tr>
		<th>#</th>
		<th>
			<a href="<?php print $order_id_link; ?>" class="has-popover" data-content="<?php print SBText::_('STATS_LOGIN_ERRORS_TH_ID'); ?>">
				ID
			</a>
		</th>
		<th>
			<a href="<?php print $order_fname_link; ?>" class="has-popover" data-content="<?php print SBText::_('STATS_LOGIN_ERRORS_TH_USER'); ?>">
		...
		<th>
			<a href="<?php print $order_lname_link; ?>" class="has-popover" data-content="<?php print SBText::_('STATS_LOGIN_ERRORS_TH_USER'); ?>">
		...
		<th>
			<a href="<?php print $order_auths_link; ?>" class="has-popover" data-content="<?php print SBText::_('STATS_LOGIN_ERRORS_TH_ERRORS'); ?>">
				<?php print SB_Text::_('Errores', 'statistics'); ?>
