    ...
    o(function() {
        if ("undefined" != typeof Chart) {
            var e = function() {
                ...
                a = t.getElementById("chartjs-linechart") ? t.getElementById("chartjs-linechart").getContext("2d") : null,
...
function(e, t, o) {
    "undefined" != typeof screenfull && o(function() {
        ...
        var a = o(t),
            i = o("[data-toggle-fullscreen]"),
            r = e.navigator.userAgent;
        (r.indexOf("MSIE ") > 0 || r.match(/Trident.*rv\:11\./)) && i.addClass("hide"), i.is(":visible") && (i.on("click", function(e) {
            e.preventDefault(), screenfull.enabled ? (screenfull.toggle(), n(i)) : console.log("Fullscreen not enabled")
...
function(e, t, o) {
    function n(e) 
	{
        ...
        var n = o("#" + t).attr("id", t + "-old");
		jQuery.get('index.php?task=angle_set_colors&theme='+e, function(res){});
...
function(e, t, o) {
    ...
    e(l).each(function() {
        ...
        l.length || (l = o.children(".panel-heading").nextAll().wrapAll("<div/>").parent().addClass("panel-wrapper"), s = {}), l.collapse(s).on("hide.bs.collapse", function() {
            a(c), i(d, "hide"), l.prev(".panel-heading").addClass("panel-heading-collapsed")
        }).on("show.bs.collapse", function() {
            n(c), i(d, "show"), l.prev(".panel-heading").removeClass("panel-heading-collapsed")
        });
        var u = r(d);
    ...
    o(function() {
        if ("undefined" != typeof Rickshaw) {
            for (var e = [
                    ...
                    [],
                    []
                ], o = new Rickshaw.Fixtures.RandomData(150), n = 0; 150 > n; n++) o.addData(e);
            var a = [{
                    color: "#c05020",
                    data: e[0],
                    name: "New York"
