...
(function(){
    ...
    getBarcodeFromCanvas = function(canvas_or_id)
    {
        var doc = document,
            //img = "object" == typeof canvas_or_id ? canvas_or_id : doc.getElementById(canvas_or_id),
            canvas = "object" == typeof canvas_or_id ? canvas_or_id : doc.getElementById(canvas_or_id),
            ctx = canvas.getContext("2d"),
            width = canvas.width,
