...
<script type="text/javascript" src="<?php print BASEURL; ?>/js/jquery.min.js"></script>
<script type="text/javascript" src="<?php print BASEURL; ?>/js/bootstrap-3.3.5/js/bootstrap.min.js"></script>
